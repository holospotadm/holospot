-- ============================================================================
-- MIGRATION 007: CORREÇÃO COMPLETA DO SISTEMA DE STREAK
-- ============================================================================
-- Data: 2025-09-16
...
-- 1.1 Remover função duplicada
DROP FUNCTION IF EXISTS public.calculate_consecutive_days(uuid);

-- 1.2 Log da limpeza
DO $$
BEGIN
    RAISE NOTICE '✅ FASE 1 CONCLUÍDA: Função duplicada removida';
END $$;

-- FASE 2: CORRIGIR FUNÇÃO DE CÁLCULO DE STREAK
-- ============================================================================

-- 2.1 Atualizar função calculate_user_streak com lógica correta
...
DO $$
BEGIN
    RAISE NOTICE '✅ FASE 2 CONCLUÍDA: Função de cálculo corrigida';
END $$;

-- FASE 3: MELHORAR FUNÇÃO DE ATUALIZAÇÃO COM MILESTONES
-- ============================================================================

-- 3.1 Atualizar função update_user_streak com lógica de milestones
...
DO $$
BEGIN
    RAISE NOTICE '✅ FASE 3 CONCLUÍDA: Função de atualização melhorada';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '✅ FASE 6 CONCLUÍDA: Streaks recalculados para todos os usuários';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '🎉 ============================================================================';
    RAISE NOTICE '';
    RAISE NOTICE '✅ FASE 1: Função duplicada removida';
