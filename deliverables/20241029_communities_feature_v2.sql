-- ============================================
-- MIGRATION: Communities Feature (CORRIGIDA)
-- Descrição: Adiciona funcionalidade completa de Comunidades
-- Autor: HoloSpot Team
-- Data: 2024-10-29
-- Versão: 2.0.0 (ordem corrigida)
-- ============================================

-- ========================================
-- PARTE 1: CRIAR NOVAS TABELAS PRIMEIRO
-- ========================================

-- 1.1: Tabela communities
...
-- ========================================
-- PARTE 2: MODIFICAÇÕES EM TABELAS EXISTENTES
-- ========================================

-- 2.1: Adicionar campo community_owner em profiles
...
-- 2.2: Adicionar campo community_id em posts (AGORA que communities existe)
ALTER TABLE posts 
...
DO $$
BEGIN
    RAISE NOTICE '✅ Migration 20241029_communities_feature_v2 executada com sucesso!';
