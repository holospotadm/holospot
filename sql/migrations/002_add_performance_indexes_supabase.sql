-- ============================================================================
-- MIGRATION 002: Adicionar Índices de Performance (VERSÃO SUPABASE)
-- ============================================================================
-- Data: 2025-09-16
-- Objetivo: Melhorar performance das consultas mais frequentes
-- Versão: SEM CONCURRENTLY (para Supabase SQL Editor)
-- ============================================================================
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '⚠️  NOTA: Índices criados SEM CONCURRENTLY devido ao Supabase SQL Editor';
    RAISE NOTICE '   Em produção, considere usar CONCURRENTLY para evitar bloqueios';
END $$;
