-- ============================================================================
-- IMPLEMENTAÇÃO: Nova lógica INCREMENTAL de streak
-- ============================================================================
-- Data: 2025-11-12
-- Problema: Lógica atual recalcula TUDO (1460 queries) a cada atividade
-- Solução: Lógica incremental usando user_streaks como fonte da verdade
-- Performance: 100x mais rápido (2 queries vs 1460)
-- ============================================================================

-- ============================================================================
-- PASSO 1: Criar nova função incremental
-- ============================================================================
...
-- ============================================================================
-- PASSO 2: Criar wrapper para compatibilidade com código existente
-- ============================================================================
...
-- ============================================================================
-- PASSO 3: Atualizar função update_user_streak para usar lógica incremental
-- ============================================================================
...
-- ============================================================================
-- PASSO 4: Função auxiliar para recalcular streak do zero (usar apenas se necessário)
-- ============================================================================
...
--
-- Para recalcular do zero (se necessário):
-- SELECT recalculate_user_streak_from_scratch('seu-user-id');
-- ============================================================================

-- ============================================================================
-- NOTAS IMPORTANTES
-- ============================================================================
-- 1. A função update_user_streak agora usa lógica incremental
-- 2. Os triggers continuam funcionando normalmente
-- 3. Performance: 2 queries vs 1460 (100x mais rápido!)
-- 4. user_streaks é agora a fonte da verdade
-- 5. recalculate_user_streak_from_scratch disponível para casos especiais
-- ============================================================================
