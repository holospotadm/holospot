-- ============================================================================
-- Fix: Corrigir referências ambíguas a current_streak
-- ============================================================================
-- Data: 2025-11-12
-- Problema: column reference "current_streak" is ambiguous
-- Causa: RETURNS TABLE define colunas com mesmo nome da tabela user_streaks
-- Solução: Qualificar explicitamente com nome da tabela
-- ============================================================================
...
-- VERIFICAÇÃO
-- ============================================================================
-- Testar criando um post - não deve mais dar erro de ambiguidade
-- ============================================================================
