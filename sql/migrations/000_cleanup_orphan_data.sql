-- ============================================================================
-- MIGRATION 000: Limpeza de Dados Órfãos
-- ============================================================================
-- Data: 2025-09-16
...
-- Mostrar authors órfãos
RAISE NOTICE '🔍 AUTHORS ÓRFÃOS EM FEEDBACKS:';
...
-- Mostrar posts órfãos
RAISE NOTICE '🔍 POSTS ÓRFÃOS EM FEEDBACKS:';
...
-- Mostrar mentioned users órfãos
RAISE NOTICE '🔍 MENTIONED USERS ÓRFÃOS EM FEEDBACKS:';
...
-- OPÇÃO 1: Deletar feedbacks órfãos (RECOMENDADO)
-- ============================================================================
...
-- OPÇÃO 2: Corrigir user_points.level_id inválidos
-- ============================================================================
...
-- ============================================================================
/*
-- Para recuperar dados deletados (se necessário):
INSERT INTO feedbacks SELECT * FROM feedbacks_backup;
INSERT INTO user_points SELECT * FROM user_points_backup;
*/
