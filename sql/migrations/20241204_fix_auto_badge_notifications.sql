-- ============================================================================
-- FIX: Corrigir INSERT de notificações em auto_badge_check_bonus
-- ============================================================================
-- PROBLEMA: Função tenta inserir title, reference_type, reference_id
--           mas tabela notifications não tem essas colunas
-- SOLUÇÃO: Usar apenas colunas que existem: user_id, type, message
-- ============================================================================
...
COMMENT ON FUNCTION public.auto_badge_check_bonus IS 'Verifica e concede badges automaticamente (CORRIGIDO: notificações com estrutura correta)';
