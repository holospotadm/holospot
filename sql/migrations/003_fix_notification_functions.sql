-- ============================================================================
-- MIGRATION 003: Corrigir Sistema de Notificações
-- ============================================================================
-- Data: 2025-09-16
...
BEGIN
    ...
    IF test_user_id IS NOT NULL THEN
        ...
        PERFORM create_single_notification(
            ...
            NULL, 
            'test', 
            'Teste de notificação - Migration 003', 
            1
        );
...
BEGIN
    ...
    RAISE NOTICE '   ✅ create_single_notification() - Criada';
    ...
    RAISE NOTICE '';
    RAISE NOTICE '📱 PRÓXIMO PASSO: Melhorar auto-refresh do frontend';
END $$;
