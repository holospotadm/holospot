...
WHERE actor_id IN (SELECT id FROM _seed_cleanup_ids)
...
FROM (VALUES
    ...
    ('carlos.henrique', 'pelada-quinta', 'admin'),
    ...
    ('marcos.vinicius', 'corre-sp', 'admin'),
...
ALTER TABLE public.comments  DISABLE TRIGGER comment_notification_trigger;
...
ALTER TABLE public.comments  ENABLE TRIGGER comment_notification_trigger;
...
DELETE FROM public.notifications
WHERE actor_id IN (SELECT user_id FROM _seed_users);
