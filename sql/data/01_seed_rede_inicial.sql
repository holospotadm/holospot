-- ARQUIVO CANÔNICO: 01_seed_rede_inicial.sql
-- Cópia de: seed_rede_inicial_v8_SEED.sql (versão final executada com sucesso)
-- Este é o seed oficial do ambiente de desenvolvimento HoloSpot.
