...
-- ============================================================================
-- NOTA: Policies simples para evitar recursão infinita
-- Controle de acesso feito via funções SECURITY DEFINER
...
-- ============================================================================
-- NOTA: Policies que suportam comunidades SEM causar recursão
